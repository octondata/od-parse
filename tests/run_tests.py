...
def run_pytest():
    ...
    try:
        ...
        try:
            ...
            print(
                "📊 Coverage not available (install with: pip install coverage pytest-cov)"
            )
...
def run_security_checks():
    ...
    debug_files = list(project_root.glob("test_*.py")) + list(
        project_root.glob("debug_*.py")
    )
