...
from od_parse.converter.markdown_converter import format_text_content, format_table, format_form_element
...
class TestMarkdownConverter(unittest.TestCase):
    ...
    def test_convert_to_markdown_with_tables(self):
        ...
        parsed_data = {
            ...
            'tables': [
                ...
                [{'Product': 'Widget', 'Price': 10.99}, {'Product': 'Gadget', 'Price': 19.99}]
            ],
            'forms': [],
            'handwritten_content': []
        }
    ...
    def test_convert_to_markdown_with_forms(self):
        ...
        parsed_data = {
            ...
            'tables': [],
            'forms': [
                {'type': 'checkbox', 'text': 'Check this box', 'page': 1, 'bbox': (10, 20, 30, 40)},
                {'type': 'radio', 'text': 'Select an option', 'page': 1, 'bbox': (50, 60, 70, 80)}
            ],
            'handwritten_content': []
        }
    ...
    def test_convert_to_markdown_with_handwritten(self):
        ...
        parsed_data = {
            ...
            'tables': [],
            'forms': [],
            'handwritten_content': ['This is handwritten text.', 'More handwritten text.']
        }
    ...
    def test_format_form_element(self):
        ...
        self.assertIn("**Position:** (x1=10.50, y1=20.50, x2=30.50, y2=40.50)", formatted)
