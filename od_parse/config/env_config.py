...
def get_api_key(provider: str) -> Optional[str]:
    ...
    logger.warning(f"No API key found for {provider}. Check your .env file or environment variables.")
    return None
...
def get_model_config(provider: str) -> Dict[str, Any]:
    ...
    config = {
        ...
        'model': os.environ.get(f'{provider.upper()}_MODEL', default_models.get(provider)),
...
def get_feature_flags() -> Dict[str, bool]:
    ...
    return {
        'enable_deep_learning': str_to_bool(os.environ.get('ENABLE_DEEP_LEARNING', 'true')),
        'enable_advanced_ocr': str_to_bool(os.environ.get('ENABLE_ADVANCED_OCR', 'true')),
        'enable_multilingual': str_to_bool(os.environ.get('ENABLE_MULTILINGUAL', 'true')),
