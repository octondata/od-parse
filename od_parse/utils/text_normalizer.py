...
def normalize_ocr_spacing(text: str) -> str:
    ...
    # "01 - 15 - 2025" -> "01-15-2025"
    normalized = re.sub(r'(\d{1,2})\s*/\s*(\d{1,2})\s*/\s*(\d{2,4})', r'\1/\2/\3', normalized)
    normalized = re.sub(r'(\d{1,2})\s*-\s*(\d{1,2})\s*-\s*(\d{2,4})', r'\1-\2-\3', normalized)
...
def normalize_i94_fields(extracted_data: Dict[str, Any]) -> Dict[str, Any]:
    ...
    date_fields = [
        ...
        'admit_until_date', 'expiration_date',
        'processing_date', 'issue_date'
    ]
    ...
    name_fields = [
        ...
        'given_name', 'surname', 'middle_name'
    ]
    ...
    doc_fields = [
        'document_number', 'i94_number', 'i94_record_number',
        'admission_number', 'passport_number'
    ]
    ...
    country_fields = [
        'country_of_citizenship', 'country', 'nationality',
        'passport_country', 'country_of_issuance'
    ]
