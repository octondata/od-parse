...
class DatabaseConnector(DataConnector):
    ...
    def _export_sqlite(self, data: Dict[str, Any]) -> bool:
        ...
        try:
            ...
            for page in data.get("pages", []):
                ...
                cursor.execute(
                    "INSERT INTO pages VALUES (?, ?, ?)", (page_id, doc_id, page_num)
                )
    ...
    def _export_postgres(self, data: Dict[str, Any]) -> bool:
        ...
        try:
            ...
            self.logger.error(
                "psycopg2 module not installed. Please install it to use PostgreSQL."
            )
            return False
    ...
    def _import_sqlite(self) -> Dict[str, Any]:
        ...
        try:
            ...
            data = {
                ...
                "file_name": doc[1],
                "file_size": doc[2],
                "document_info": {"page_count": doc[3]},
            ...
            for page in pages:
                ...
                page_data = {"page_number": page_num, "tables": []}

                # Query tables
                cursor.execute("SELECT * FROM tables WHERE page_id = ?", (page_id,))
...
class VectorDBConnector(DataConnector):
    ...
    def _export_pgvector(self, data: Dict[str, Any]) -> bool:
        ...
        try:
            ...
            self.logger.error(
                "psycopg2 module not installed. Please install it to use pgvector."
            )
            return False
