...
class ParsingAgent:
    ...
    def __init__(
        ...
        logger.info(f"ParsingAgent initialized with strategy={strategy.value}, "
    ...
    def analyze_document(self, file_path: Path) -> DocumentProfile:
        ...
        logger.info(f"Document profile: {page_count} pages, {complexity} complexity, "
    ...
    def create_processing_plan(
        ...
        logger.info(f"Processing plan created: {plan.strategy.value}, "
    ...
    def _create_adaptive_plan(self, profile: DocumentProfile) -> ProcessingPlan:
        ...
        if profile.is_scanned:
            ...
            reasoning_parts.append("Has images: medium-quality processing for first 10 pages")
        else:
        ...
        estimated_memory_mb = self._estimate_memory(profile, image_dpi, max_pages_for_images)
    ...
    def record_processing_result(
        ...
        logger.info(f"Recorded processing result: time={actual_time:.2f}s "
